<tool id="modencode_peakcalling_macs2" name="MACS2" version="2.0.10.09132012">
  ...
  <command interpreter="python">macs2_wrapper.py $options_file $output_bed_file $output_extra_files $output_extra_files.files_path $output_peaks_file</command>
  <requirements>
  ...
  <inputs>
    ...
    <!--<conditional name ="gsize_type">
      <param name="gsize_selector" type="select" label="Effective genome size">
	...
	<option value="fly">Fly</option>
      ...
      <when value="human">
	<param name="gsize" type="float" label="Effective genome size" value="3300000000"/>
      </when>
      <when value="mouse">
	<param name="gsize" type="float" label="Effective genome size" value="3000000000"/>
      </when>
      <when value="worm">
	<param name="gsize" type="float" label="Effective genome size" value="120000000"/>
      </when>
      <when value="fly">
	<param name="gsize" type="float" label="Effective genome size" value="190000000"/>
      </when>
    </conditional>-->
