...
import subprocess	# August 13, 2012: imported to call command line perl script
...
# August 13, 2012
# OICR: KMC 
# Made additions for compatibility with modENCODE faceted browser
# Calls perl script that parses URL list to download and extract files
###############################################################################################
	   
    subprocess.call("perl " + modENCODE_getData + " " + cur_filename + " output1 " + outputID + " " + newFilePath, shell=True)
